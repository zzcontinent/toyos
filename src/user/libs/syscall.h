...
extern int sys_execve(const char *name, int argc, const char **argv);
extern int sys_yield(void);
extern int sys_kill(int pid);
extern int sys_getpid(void);
extern int sys_putc(int c);
extern int sys_pgdir(void);
extern int sys_nanosleep(unsigned int time);
...
extern int sys_lseek(int fd, off_t pos, int whence);
